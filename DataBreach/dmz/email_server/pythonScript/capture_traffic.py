...
if __name__ == "__main__":
    print("Inside the wireshark capture scritp of the email server!!!")

    capture_file = "/home/captureTraffic/email_capture.pcap"
    ...
    input("\nPress the ENTER key to stop the capture on the email server...\n")
