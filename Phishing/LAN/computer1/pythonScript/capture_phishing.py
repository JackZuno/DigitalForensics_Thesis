...
def start_capture(capture_file):    
    ...
    tshark_process = subprocess.Popen(
        ["tshark", "-w", capture_file, "-b", "filesize:100000"],  
...
if __name__ == "__main__":
    print("Inside the wireshark capture scritp of the computer1 (phishing)!!!")

    capture_file = "/home/sarahwilliams/networkCapture/phishing/phishing.pcap"
    ...
    input("\nPress the ENTER key to stop the capture on the computer1 (phishing)...\n")
