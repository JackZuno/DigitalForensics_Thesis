...
if __name__ == "__main__":
    print("Inside the wireshark capture scritp of the firewall!!!")

    capture_file = "/home/captureTraffic/firewall_capture.pcap"
    ...
    input("\nPress the ENTER key to stop the capture on the firewall...\n")
